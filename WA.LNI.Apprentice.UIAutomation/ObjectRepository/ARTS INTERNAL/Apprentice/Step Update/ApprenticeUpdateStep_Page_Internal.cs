...
namespace WA.LNI.Apprentice.UIAutomation.ObjectRepository.ARTS_INTERNAL.Apprentice.Step_Update
{
    ...
    public class ApprenticeUpdateStep_Page_Internal
    {
        ...
        [FindsByAll]
        [FindsBy(How = How.XPath, Using = "//b[contains(text(),'Program Name:')]//following::span[1]/div/ul/li/span")]
        ...
        [FindsBy(How = How.XPath, Using = "//label[contains(@class,'ng-tns-c4-931 ui-dropdown-label ui-inputtext ui-corner-all ui-placeholder')]")]
        public IWebElement OccupationNameDrpDwnBtn { get; set; }

        [FindsByAll]
        [FindsBy(How = How.XPath, Using = "//b[contains(text(),'Occupation Name:')]//following::div[1]/div/div/ul/li/span")]
        ...
        [FindsByAll]
        [FindsBy(How = How.XPath, Using = "//tbody[contains(@class,'ui-datatable-data ui-widget-content ui-datatable-hoverable-rows')]//child::tr/td[2]/span[2]")]
        public IList<IWebElement> ApprenticeIDTableTxt { get; set; }

        [FindsByAll]
        [FindsBy(How = How.XPath, Using = "//tbody[contains(@class,'ui-datatable-data ui-widget-content ui-datatable-hoverable-rows')]//child::tr/td[3]/span[2]")]
        public IList<IWebElement> FirstNameTableTxt { get; set; }

        [FindsByAll]
        [FindsBy(How = How.XPath, Using = "//tbody[contains(@class,'ui-datatable-data ui-widget-content ui-datatable-hoverable-rows')]//child::tr/td[4]/span[2]")]
        public IList<IWebElement> LastNameTableTxt { get; set; }

        [FindsByAll]
        [FindsBy(How = How.XPath, Using = "//tbody[contains(@class,'ui-datatable-data ui-widget-content ui-datatable-hoverable-rows')]//child::tr/td[5]/span[2]")]
        public IList<IWebElement> ProgramNameTableTxt { get; set; }

        [FindsByAll]
        [FindsBy(How = How.XPath, Using = "//tbody[contains(@class,'ui-datatable-data ui-widget-content ui-datatable-hoverable-rows')]//child::tr/td[6]/span[2]")]
        public IList<IWebElement> OccupationNameTableTxt { get; set; }

        [FindsByAll]
        [FindsBy(How = How.XPath, Using = "//tbody[contains(@class,'ui-datatable-data ui-widget-content ui-datatable-hoverable-rows')]//child::tr/td[7]/span[2]")]
        ...
        public void ApprenticeSlection_ChkBox(string n)
        {
            ...
            {
                Selenium.Driver.Click(ApprenticeSelectionTableChkBox[i], "ApprenticeSelectionTableChkBox[" + i + "]");
            }         
        }
